...
class PlaneTailSettings extends StatefulWidget {
  final Map<String, dynamic> initialData;
  final Function(Map<String, dynamic>) onSave;

  const PlaneTailSettings({
    super.key,
  ...
  @override
  State<PlaneTailSettings> createState() => _PlaneTailSettingsState();
}

class _PlaneTailSettingsState extends State<PlaneTailSettings> {
  ...
  Widget build(BuildContext context) {
    return _buildDialog(context, 'Хвост');
  }
    ...
    return GestureDetector(
      ...
      child: Dialog(
        ...
        insetPadding: EdgeInsets.only(
          top: MediaQuery.of(context).padding.top + 40, // 40 пикселей вниз
        ),
