...
class PlaneWingL_SETTINGS extends StatefulWidget {
  final Map<String, dynamic> initialData;
  final Function(Map<String, dynamic>) onSave;

  const PlaneWingL_SETTINGS({
    super.key,
  ...
  @override
  State<PlaneWingL_SETTINGS> createState() => _PlaneWingL_SETTINGSState();
}

class _PlaneWingL_SETTINGSState extends State<PlaneWingL_SETTINGS> {
    ...
    return GestureDetector(
      ...
      child: Dialog(
        ...
        insetPadding: EdgeInsets.only(
          top: MediaQuery.of(context).padding.top + 40, // !!! 40 пикселей
        ),
