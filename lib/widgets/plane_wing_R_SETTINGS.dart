...
class PlaneWingR_SETTINGS extends StatefulWidget {
  final Map<String, dynamic> initialData;
  final Function(Map<String, dynamic>) onSave;

  const PlaneWingR_SETTINGS({
    super.key,
  ...
  @override
  State<PlaneWingR_SETTINGS> createState() => _PlaneWingR_SETTINGSState();
}

class _PlaneWingR_SETTINGSState extends State<PlaneWingR_SETTINGS> {
